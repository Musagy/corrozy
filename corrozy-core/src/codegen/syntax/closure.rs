...
use crate::parser::ast::{AstNode, Block, ClosureBody, ElseClause, Expression, FunctionCallExp, Parameter};
#[derive(Clone)]
...
impl ClosureGenerator {
    ...
    fn generate_use_clause(&self,
        ...
        // Variables que necesitan ser capturadas = usadas - declaradas_localmente
        let captured_vars: HashSet<String> = used_vars.difference(&declared_vars)
            .cloned()  // Necesario para convertir &String a String
            .collect();
